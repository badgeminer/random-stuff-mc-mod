...
package net.mcreator.randomstuff.world.dimension;
...
public class NoobWorldDimension {
	...
	public static class Fixers {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("random_stuff:noob_world"), customEffect));
		}
	}
}
