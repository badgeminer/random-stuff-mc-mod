...
package net.mcreator.randomstuff.world.inventory;
...
public class TempestCrafterGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public TempestCrafterGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RandomStuffModMenus.TEMPEST_CRAFTER_GUI, id);
		...
		this.customSlots.put(9, this.addSlot(new SlotItemHandler(internal, 9, 79, 53) {
		}));
