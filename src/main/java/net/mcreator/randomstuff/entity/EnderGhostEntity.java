...
public class EnderGhostEntity extends Monster {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.PINK,
			ServerBossEvent.BossBarOverlay.PROGRESS);

	public EnderGhostEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RandomStuffModEntities.ENDER_GHOST.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(RandomStuffModItems.SHADOW_GEM.get()));
	}
