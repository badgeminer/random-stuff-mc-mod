...
import net.mcreator.randomstuff.client.gui.TempestCrafterGuiScreen;
...
public class RandomStuffModScreens {
	...
	public static void clientLoad(FMLClientSetupEvent event) {
		event.enqueueWork(() -> {
			...
			MenuScreens.register(RandomStuffModMenus.TEMPEST_CRAFTER_GUI, TempestCrafterGuiScreen::new);
		});
	}
}
