...
public class TempestCrafterGuiScreen extends AbstractContainerScreen<TempestCrafterGuiMenu> {
	...
	public TempestCrafterGuiScreen(TempestCrafterGuiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("random_stuff:textures/tempest_crafter_gui.png");
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 114, this.topPos + 52, 51, 20, new TextComponent("CRAFT"), e -> {
			if (true) {
				...
				TempestCrafterGuiButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
