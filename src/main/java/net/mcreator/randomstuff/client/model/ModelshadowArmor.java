package net.mcreator.randomstuff.client.model;
...
public class ModelshadowArmor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("random_stuff", "modelshadow_armor"), "main");
