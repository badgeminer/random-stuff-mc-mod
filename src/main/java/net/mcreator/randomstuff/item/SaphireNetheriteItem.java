...
import net.mcreator.randomstuff.procedures.SaphireNeteriteTickProcedure;
import net.mcreator.randomstuff.init.RandomStuffModTabs;

public abstract class SaphireNetheriteItem extends ArmorItem {
	public SaphireNetheriteItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends SaphireNetheriteItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "random_stuff:textures/models/armor/saphirenetherite__layer_1.png";
		}

		@Override
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			SaphireNeteriteTickProcedure.execute(entity);
		}
	}
	...
	public static class Leggings extends SaphireNetheriteItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "random_stuff:textures/models/armor/saphirenetherite__layer_2.png";
		}
	}
